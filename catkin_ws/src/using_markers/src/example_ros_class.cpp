...
void ExampleRosClass::initializeSubscribers()
{
    ...
    tf_subscriber_ = nh_.subscribe("husky_velocity_controller/odom/pose/pose/position", 1, &ExampleRosClass::subscriberCallback,this);
...
void ExampleRosClass::initializePublishers()
{
    ...
    marker_publisher_ = nh_.advertise<std_msgs::Marker>("visualization_marker", 1, true);
